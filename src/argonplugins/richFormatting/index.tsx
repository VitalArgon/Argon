...
// Suffixes tried in order when a bare name (or "...icon") doesn't resolve.
// Covers cases like brand icons that come in variants, e.g. "spotify" ->
...
function buildPluginCardSpan(rawName: string) {
    ...
    const pluginInfo = [
        ...
        {
            condition: PluginMeta[plugin.name]?.folderName?.startsWith("src/argonplugins/"),
...
export default definePlugin({
    ...
    tags: ["Utility", "Argon", "Fun"],
    authors: [ArgonDevs.Zarak],
    settings,
    dependencies: ["CommandsAPI", "ArgonCoreAPI"],
